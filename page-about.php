		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-12 text-center">
					...
					<?php if ( get_field( 'associate_hero_text' ) ) : ?>

						<?php the_field( 'associate_hero_text' ); ?>
					...
					<div class="col-sm-2">
						...
						<div class="member-box">
							...
							<?php $image_attributes = wp_get_attachment_image_src( $post_thumbnail_id, "full" );?>
								...
								<h3 class="text-center title"><?php the_field( 'position' ); ?></h3>
			...
			<div class="row">
				...
				<div class="col-sm-12 text-center">
					...
					<a class="btn btn-lg btn-primary purple-btn" href="<?php echo get_site_url( ); ?>/associates">See all the associates</a>
